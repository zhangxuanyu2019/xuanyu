...
Surge
[Script]
灏忕背杩愬姩 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=3600,script-path=xmbs.js
灏忕背杩愬姩鑾峰彇Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=backUp/xmbs.js
鍦圶
[task_local]
# 灏忕背杩愬姩
15 17 * * * xmbs.js, tag=灏忕背杩愬姩, img-url=http://ox.xmkczs.com/quantumultX/xmbs.png, enabled=true
[rewrite_local]
# 灏忕背杩愬姩鑾峰彇Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmbs.js.js
Loon
[Script]
cron "15 17 * * *" script-path=xmbs.js, tag=灏忕背杩愬姩
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=xxmbs.js, requires-body=true, timeout=3600, tag=灏忕背杩愬姩鑾峰彇Token
 */
